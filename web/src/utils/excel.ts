 ...
 * @returns
 */
const getExcelSheet = (data: string | ArrayBuffer, sheetNum: number) => {
 ...
 * @returns
 */
export const getExcelJson = <T>(data: string | ArrayBuffer, sheetNum: number) => {
  const sheet = getExcelSheet(data, sheetNum);
 ...
 * @returns
 */
export const getExcelHeaders = (data: string | ArrayBuffer, sheetNum: number) => {
  const sheet = getExcelSheet(data, sheetNum);
  const headers = [];
  if (sheet["!ref"]) {
 ...
 * @returns
 */
export const formatExcelDate = (date: number) => {
